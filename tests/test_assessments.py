...
def test_parse_success(
    ...
    assert res_json["clinicalDetails"]["chiefComplaint"] == "Shoulder pain"
    assert res_json["clinicalDetails"]["duration"] == "2 weeks"

@patch("app.api.routes.assessments.create_assessment")
def test_save_assessment_success(mock_create, client, mock_mongo_client):
