...
docs/
└── golden_output.json   # verified output from provided WAV (after running)
```
...
**4. Confidence threshold and retry**
...
**8. Deliberate scope cuts (documented)**
...
**Groq API errors**
Verify `GROQ_API_KEY` and `GROQ_MODEL` in `.env`. If `llama-3.3-70b-versatile` is unavailable, try `llama-3.1-70b-versatile`.

---

## Deliverables Checklist

- [x] D1: FastAPI service with 4 endpoints
- [x] D2: Whisper transcription module
- [x] D3: LangGraph agent with Pydantic output
- [x] D4: MongoDB models + repository
- [x] D5: Test script runs on provided WAV
- [x] D6: README with setup and design decisions