...
@router.post(
    ...
    description=(
        ...
        "`flaggedFields` distinguishes two cases: `not_stated` (the recording "
        "never covered it) and `rejected` (the model produced a value that "
        "failed verification and was discarded).\n\n"
